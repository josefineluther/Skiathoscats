...
fetch('https://api.thecatapi.com/v1/breeds/search?q=' + breed + '&api_key=live_CMkDEOCKpbBXxlkAvCfVu0QwpdhoZrJZiVk2jR62CgKn9Rv0NbHqgfQyYgy6PfQK&')
    ...
    .then(result => {
        ...
        imageAndInfo.innerHTML = '<img src="' + result[0].image.url + '" alt="' + result[0].name + '"><div><p>Temperament: ' + result[0].temperament + '</p><p>Origin: ' + result[0].origin + '</p><p>Lifespan: ' + result[0].life_span + '</p><p>' + result[0].description + '</p></div>'
